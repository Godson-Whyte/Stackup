...
# ╔═╡ b0b1a628-738a-4db6-ac32-28648f4e2ab4
begin
	using DataFrames
	using CSV
end

# ╔═╡ fac427d1-f389-404c-a973-6fc29a1132ef
using Plots  # This will install plots


# ╔═╡ 2ab93f00-8d1d-4cdf-b9fa-a765d85168d8
using PlutoUI


# ╔═╡ 978c8fb6-21ff-4c5a-a4fa-4beb0f88fe7c
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)


# ╔═╡ f145ece5-9627-4710-9075-7b118035d13c
df.Country_code === df[!, "Country_code"]


# ╔═╡ ca7d1819-2a60-4200-9828-50747e802ff9
equals_sg(x::AbstractString) = x == "SG"


# ╔═╡ 109d9dea-cb70-4fdd-878a-19409d0d92bc
sg_data = filter(:Country_code => equals_sg, df)


# ╔═╡ acce6961-4b59-47e3-9763-449ee2d34778
dates = sg_data[!, "Date_reported"]


# ╔═╡ 05f0bfbf-4b77-4083-81fe-4d68b3afea68
cumulative_cases = sg_data[!, "Cumulative_cases"]


# ╔═╡ d5dd7ec4-ec1b-4105-afdd-3df34ed88da0
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)


# ╔═╡ 24a17708-8110-40b0-82b7-ff368a51e5b8
...
# ╔═╡ 757d2d0a-01e9-4ed1-8460-a9a5a610c2c0
@bind slider_value Slider(0:10:1000)


# ╔═╡ d57cb05a-3d6d-4a6d-94f1-d69a937ec8d0
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 29f814e4-c88c-4053-ae65-737971801a1f
@bind date_slider_index Slider(1:length(dates))


# ╔═╡ 694ae907-bc69-4f6d-83e5-df9dbe707d0d
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ dda0e424-61cb-4546-ad4b-9a8e15668b63
